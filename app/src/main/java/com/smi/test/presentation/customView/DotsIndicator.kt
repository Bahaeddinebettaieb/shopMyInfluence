package com.smi.test.presentation.customView
...
class DotsIndicator : LinearLayout {
    ...
    private var mIndicatorBackgroundResId = R.drawable.ic_dot_darkgreen
    private var mIndicatorUnselectedBackgroundResId = R.drawable.ic_dot_lightgreen
    ...
    private fun checkIndicatorConfig() {
        ...
        mIndicatorBackgroundResId =
            if (mIndicatorBackgroundResId == 0) R.drawable.ic_dot_lightgreen else mIndicatorBackgroundResId
        mIndicatorUnselectedBackgroundResId =
